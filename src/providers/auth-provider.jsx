...
import { userData } from "@/constants/seed";
...
const AuthProvider = ({ children }) => {
  useEffect(() => {
    if (!getLocalStorageItem(StorageKeys.USERS)) {
      setLocalStorageItem(StorageKeys.USERS, userData);
    }
  }, []);

  const [users, setUsers] = useState(
    getLocalStorageItem(StorageKeys.USERS) || userData,
  );
